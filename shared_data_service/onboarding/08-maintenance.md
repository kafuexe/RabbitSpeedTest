...
| Module shape or dependency rules (the single-file module layout, `ModuleSpec`/`ALL_SPECS`, routes → service → repository, module isolation) | [Architecture Tour](03-architecture-tour.md) + [Adding a Module](05-adding-a-module.md) |
