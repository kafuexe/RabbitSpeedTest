...
EntityRoutes (app/modules/shared/routes.py) — no route code lives here.
...
# EntityRoutes from PROJECT_SPEC. Registered in app/modules/__init__.py
# (ALL_SPECS) — the only other file a new entity touches.
